...
Игра доступна онлайн: **[https://dontsov.github.io/100_k_1/](https://dontsov.github.io/100_k_1/)** (замените на ваш URL)

⚠️ **Важно**: Онлайн версия НЕ сохраняет состояние игры между сеансами.

### Скачать и играть локально (Рекомендуется)
Для сохранения прогресса и настроек:

1. Скачайте проект с [GitHub](https://github.com/dontsov/100_k_1) (замените на ваш URL)
2. Откройте файл `index-prod.html` двойным кликом
3. Готово! Игра работает без интернета, состояние сохраняется локально
...
### Production режим (bundle) - Рекомендуется
Работает с протоколом `file://`. Можно открыть двойным кликом.

#### Быстрый старт (без сборки)
1. Скачайте проект
2. Откройте `index-prod.html` двойным кликом
3. Готово! Игра работает без веб-сервера
...
2. Запустите index-prod.html в любом браузере (двойной клик)
